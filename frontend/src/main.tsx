  ...
  return (
    <main>
      <header className="topbar">
        ...
        <button className="iconButton" onClick={() => void refresh()} disabled={loading} title="Refresh data">
          <RefreshCw size={18} />
          <span>Refresh</span>
        </button>
      </header>
      ...
      <section className="workspace">
        <form className="panel wide" onSubmit={(event) => void submitProject(event)}>
          ...
          <div className="grid two">
            ...
            <Field label="Operations manager" name="operations_manager_name" defaultValue="Operations Manager" required />
          </div>
            ...
            <div className="invoiceGrid">
              ...
              <div className="actions">
                <button
                  ...
                  onClick={() => void invoiceAction('/client-account-approval', { approver_name: 'Client Account Executive' }, 'Client account executive approved invoice')}
                >
                  <BadgeCheck size={18} />
                ...
                <button
                  ...
                  onClick={() => void invoiceAction('/finance-approval', { approver_name: 'Finance Manager' }, 'Finance approved invoice')}
                >
                  <FileCheck2 size={18} />
                ...
                <button
                  ...
                  onClick={() => void invoiceAction('/send', { sender_name: 'Finance Manager', recipient_email: selectedInvoice.client_contact_email }, 'Invoice sent to client')}
                >
                  <Send size={18} />
                  <span>Send</span>
                </button>
        ...
        <form
          ...
          onSubmit={(event) => {
            event.preventDefault();
            if (!selectedInvoice) return;
            void invoiceAction('/payments', formPayload(event.currentTarget), 'Payment recorded');
        ...
        >
          ...
          <Field label="Recorded by" name="recorded_by_name" defaultValue="Finance Manager" required />
          <label className="field">
            <span>Notes</span>
